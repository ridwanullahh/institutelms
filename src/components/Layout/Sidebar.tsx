...
import { Home, BookOpen, Users, FileText, MessageSquare, Calendar, BarChart3, Settings, Brain, GraduationCap, Award, Bell, Video, Mail, UserCheck, Globe, Shield, Database, Zap, BookMarked, Presentation as PresentationChart, Headphones, Camera, FileVideo, Clipboard } from 'lucide-react';
...
const Sidebar: React.FC = () => {
  ...
  const instructorMenuItems = [
    ...
    { id: 'messages', label: 'Messages', icon: Mail },
    { id: 'webinar-studio', label: 'Webinar Studio', icon: Camera },
  ];
